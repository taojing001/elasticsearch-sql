...
public class ElasticSearchResultSetMetaData implements ResultSetMetaData {
    private final List<ElasticSearchResultSetMetaData.ColumnMetaData> columns = new ArrayList<ElasticSearchResultSetMetaData.ColumnMetaData>();

    public ElasticSearchResultSetMetaData(List<String> headers){
        for(String column:headers){
            ElasticSearchResultSetMetaData.ColumnMetaData columnMetaData = new ElasticSearchResultSetMetaData.ColumnMetaData();
    ...
    public List<ElasticSearchResultSetMetaData.ColumnMetaData> getColumns() {
        return columns;
    }

    public int findColumn(String columnName) throws SQLException {
        for (int i = 0; i < columns.size(); ++i) {
            ElasticSearchResultSetMetaData.ColumnMetaData column = columns.get(i);
    ...
    public ElasticSearchResultSetMetaData.ColumnMetaData getColumn(int column) {
